...
export function FloorPlanPage() {
  ...
  const zoneByTag = useMemo(() => {
    ...
    for (const z of rtls?.zone_presence ?? []) {
      if (z.tag_id != null) lookup.set(z.tag_id, z)
    }
    return lookup
  }, [rtls])
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div className="p-4 sm:p-5">
          <div
            className="relative w-full max-w-5xl mx-auto rounded-lg bg-black shadow-inner ring-1 ring-gray-200 dark:ring-slate-700"
